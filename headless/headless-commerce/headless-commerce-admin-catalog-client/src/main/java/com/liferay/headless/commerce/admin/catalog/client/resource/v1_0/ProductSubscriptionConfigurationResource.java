 ...
 */
@Generated("")
public class ProductSubscriptionConfigurationResource {
	...
	public ProductSubscriptionConfiguration
		...
		try {
			return ProductSubscriptionConfigurationSerDes.toDTO(content);
		}
		catch (Exception e) {
			_logger.log(
	...
	public javax.ws.rs.core.Response
		...
		httpInvoker.body(
			ProductSubscriptionConfigurationSerDes.toJSON(
				productSubscriptionConfiguration),
			"application/json");
	...
	public ProductSubscriptionConfiguration
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/{id}/subscriptionConfiguration/",
			id);
	...
	public javax.ws.rs.core.Response patchProductIdSubscriptionConfiguration(
			Long id,
	...
	private static final Logger _logger = Logger.getLogger(
		ProductSubscriptionConfigurationResource.class.getName());
