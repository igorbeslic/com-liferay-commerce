...
public class ProductOptionResource {
	...
	public javax.ws.rs.core.Response deleteProductOption(Long id)
		throws Exception {
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/productOptions/{id}",
			id);
	...
	public javax.ws.rs.core.Response patchProductOption(
		...
		httpInvoker.body(
			ProductOptionSerDes.toJSON(productOption), "application/json");
	...
	public Page<ProductOption>
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/productOptions/",
	...
	public Page<ProductOption> getProductIdProductOptionsPage(
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/{id}/productOptions/",
			id);
	...
	private static final Logger _logger = Logger.getLogger(
		ProductOptionResource.class.getName());
