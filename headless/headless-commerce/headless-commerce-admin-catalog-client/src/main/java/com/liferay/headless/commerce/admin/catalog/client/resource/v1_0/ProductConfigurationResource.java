 ...
 */
@Generated("")
public class ProductConfigurationResource {
	...
	public ProductConfiguration getProductByExternalReferenceCodeConfiguration(
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/configuration/",
	...
	public javax.ws.rs.core.Response
		...
		httpInvoker.body(
			ProductConfigurationSerDes.toJSON(productConfiguration),
			"application/json");
	...
	public ProductConfiguration getProductIdConfiguration(Long id)
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/{id}/configuration/",
			id);
	...
	public javax.ws.rs.core.Response patchProductIdConfiguration(
