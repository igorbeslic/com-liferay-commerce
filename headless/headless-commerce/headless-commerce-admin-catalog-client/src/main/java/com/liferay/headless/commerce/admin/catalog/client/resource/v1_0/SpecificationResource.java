...
public class SpecificationResource {
	...
	public Specification postCatalogSiteSpecification(
		...
		httpInvoker.body(
			SpecificationSerDes.toJSON(specification), "application/json");

		httpInvoker.httpMethod(HttpInvoker.HttpMethod.POST);

		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/catalogs/{siteId}/specification/",
			siteId);
	...
	public Page<Specification> getCatalogSiteSpecificationsPage(
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/catalogs/{siteId}/specifications/",
			siteId);
	...
	public javax.ws.rs.core.Response deleteSpecification(Long id)
		throws Exception {
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/specifications/{id}",
			id);
	...
	public javax.ws.rs.core.Response patchSpecification(
