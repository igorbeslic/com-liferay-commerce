 ...
 */
@Generated("")
public class ProductTaxConfigurationResource {
	...
	public ProductTaxConfiguration
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/taxConfiguration/",
		...
		try {
			return ProductTaxConfigurationSerDes.toDTO(content);
		}
		catch (Exception e) {
			_logger.log(
	...
	public javax.ws.rs.core.Response
		...
		httpInvoker.body(
			ProductTaxConfigurationSerDes.toJSON(productTaxConfiguration),
			"application/json");
	...
	public ProductTaxConfiguration getProductIdTaxConfiguration(Long id)
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/{id}/taxConfiguration/",
			id);
	...
	public javax.ws.rs.core.Response patchProductIdTaxConfiguration(
	...
	private static final Logger _logger = Logger.getLogger(
		ProductTaxConfigurationResource.class.getName());
