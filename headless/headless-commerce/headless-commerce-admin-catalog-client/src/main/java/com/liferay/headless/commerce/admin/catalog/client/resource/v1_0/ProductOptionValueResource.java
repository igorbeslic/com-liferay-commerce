 ...
 */
@Generated("")
public class ProductOptionValueResource {
	...
	public ProductOptionValue postProductOptionIdProductOptionValue(
		...
		httpInvoker.body(
			ProductOptionValueSerDes.toJSON(productOptionValue),
			"application/json");

		httpInvoker.httpMethod(HttpInvoker.HttpMethod.POST);

		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/productOptions/{id}/productOptionValue/",
			id);
		...
		try {
			return ProductOptionValueSerDes.toDTO(content);
		}
		catch (Exception e) {
			_logger.log(
	...
	public Page<ProductOptionValue> getProductOptionIdProductOptionValuesPage(
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/productOptions/{id}/productOptionValues/",
			id);
	...
	private static final Logger _logger = Logger.getLogger(
		ProductOptionValueResource.class.getName());
