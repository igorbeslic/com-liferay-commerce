 ...
 */
@Generated("")
public class OptionCategoryResource {
	...
	public Page<OptionCategory> getCatalogSiteOptionCategoriesPage(
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/catalogs/{siteId}/optionCategories/",
			siteId);
	...
	public OptionCategory postCatalogSiteOptionCategory(
		...
		httpInvoker.body(
			OptionCategorySerDes.toJSON(optionCategory), "application/json");

		httpInvoker.httpMethod(HttpInvoker.HttpMethod.POST);

		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/catalogs/{siteId}/optionCategory/",
			siteId);
	...
	public javax.ws.rs.core.Response deleteOptionCategory(Long id)
		throws Exception {
		...
		httpInvoker.path(
			"http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/optionCategories/{id}",
			id);
	...
	public javax.ws.rs.core.Response patchOptionCategory(
	...
	private static final Logger _logger = Logger.getLogger(
		OptionCategoryResource.class.getName());
