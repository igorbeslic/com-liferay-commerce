...
public abstract class BasePriceEntryResourceImpl implements PriceEntryResource {
	...
	public Page<PriceEntry> getPriceEntries(@QueryParam("groupId") Long groupId)
		throws Exception {
	...
	public PriceEntry upsertPriceEntry(
			@QueryParam("groupId") Long groupId, PriceEntry priceEntry)
		throws Exception {
	...
	@Tags(value = {@Tag(name = "PriceEntry")})
	public Error deletePriceEntry(@PathParam("id") Long id) throws Exception {
		return new Error();
	}
	...
	@Tags(value = {@Tag(name = "PriceEntry")})
	public PriceEntry getPriceEntry(@PathParam("id") Long id) throws Exception {
		return new PriceEntry();
	}
	...
	public Error updatePriceEntry(
			@PathParam("id") Long id, PriceEntry priceEntry)
		throws Exception {
