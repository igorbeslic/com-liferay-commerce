...
public abstract class BaseProductResourceImpl implements ProductResource {
	...
	public Page<Product> getProducts(@QueryParam("groupId") Long groupId)
		throws Exception {
	...
	public Product upsertProduct(
			@QueryParam("groupId") Long groupId, Product product)
		throws Exception {
	...
	@Tags(value = {@Tag(name = "Product")})
	public Error deleteProduct(@PathParam("id") Long id) throws Exception {
		return new Error();
	}
	...
	@Tags(value = {@Tag(name = "Product")})
	public Page<Sku> getSkus(@PathParam("id") Long id) throws Exception {
		return Page.of(Collections.emptyList());
	}
