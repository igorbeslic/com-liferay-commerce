...
public abstract class BaseProductOptionResourceImpl
	...
	public ProductOption upsertProductOption(
			@QueryParam("groupId") Long groupId, ProductOption productOption)
		throws Exception {
	...
	@Tags(value = {@Tag(name = "ProductOption")})
	public Error deleteProductOption(@PathParam("id") Long id)
		throws Exception {
	...
	@Tags(value = {@Tag(name = "ProductOption")})
	public ProductOption getProductOption(@PathParam("id") Long id)
		throws Exception {
	...
	protected String getJAXRSLink(String methodName, Object... values) {
		...
		URI resourceURI = UriBuilder.fromResource(
			BaseProductOptionResourceImpl.class
		).build();

		URI methodURI = UriBuilder.fromMethod(
			BaseProductOptionResourceImpl.class, methodName
		).build(
			values
		);
