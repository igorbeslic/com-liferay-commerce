...
@Generated("")
@Path("/v2.0")
public abstract class BaseCurrencyResourceImpl implements CurrencyResource {
	...
	@Tags(value = {@Tag(name = "Currency")})
	public Page<Currency> getCurrencies(@QueryParam("groupId") Long groupId)
		throws Exception {
	...
	public Currency upsertCurrency(
			@QueryParam("groupId") Long groupId, Currency currency)
		throws Exception {
	...
	@Tags(value = {@Tag(name = "Currency")})
	public Error deleteCurrency(@PathParam("id") Long id) throws Exception {
		return new Error();
	}
	...
	@Tags(value = {@Tag(name = "Currency")})
	public Currency getCurrency(@PathParam("id") Long id) throws Exception {
		return new Currency();
	}
	...
	protected String getJAXRSLink(String methodName, Object... values) {
		...
		URI resourceURI = UriBuilder.fromResource(
			BaseCurrencyResourceImpl.class
		).build();

		URI methodURI = UriBuilder.fromMethod(
			BaseCurrencyResourceImpl.class, methodName
		).build(
			values
		);
	...
	protected void preparePatch(Currency currency) {
	}
