...
public abstract class BaseProductOptionValueResourceImpl
	...
	@Override
	@DELETE
	@Path("/productOptionValue/{id}")
	@Produces("application/json")
	@Tags(value = {@Tag(name = "ProductOptionValue")})
	public Error deleteProductOptionValue(@PathParam("id") Long id)
		throws Exception {
	...
	@Tags(value = {@Tag(name = "ProductOptionValue")})
	public ProductOptionValue getProductOptionValue(@PathParam("id") Long id)
		throws Exception {
	...
	protected String getJAXRSLink(String methodName, Object... values) {
		...
		URI resourceURI = UriBuilder.fromResource(
			BaseProductOptionValueResourceImpl.class
		).build();

		URI methodURI = UriBuilder.fromMethod(
			BaseProductOptionValueResourceImpl.class, methodName
		).build(
			values
		);
	...
	protected void preparePatch(ProductOptionValue productOptionValue) {
	}
