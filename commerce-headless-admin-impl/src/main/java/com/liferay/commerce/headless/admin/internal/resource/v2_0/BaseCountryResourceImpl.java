...
@Generated("")
@Path("/v2.0")
public abstract class BaseCountryResourceImpl implements CountryResource {
	...
	public Page<Country> getCountries(@QueryParam("groupId") Long groupId)
		throws Exception {
	...
	public Country upsertCountry(
			@QueryParam("groupId") Long groupId, Country country)
		throws Exception {
	...
	@Tags(value = {@Tag(name = "Country")})
	public Error deleteCountry(@PathParam("id") Long id) throws Exception {
		return new Error();
	}
	...
	@Tags(value = {@Tag(name = "Country")})
	public Country getCountry(@PathParam("id") Long id) throws Exception {
		return new Country();
	}
	...
	@Tags(value = {@Tag(name = "Country")})
	public Page<Region> getRegions(@PathParam("id") Long id) throws Exception {
		return Page.of(Collections.emptyList());
	}
	...
	@Tags(value = {@Tag(name = "Country")})
	public Region upsertRegion(@PathParam("id") Long id, Region region)
		throws Exception {
	...
	protected String getJAXRSLink(String methodName, Object... values) {
		...
		URI resourceURI = UriBuilder.fromResource(
			BaseCountryResourceImpl.class
		).build();

		URI methodURI = UriBuilder.fromMethod(
			BaseCountryResourceImpl.class, methodName
		).build(
			values
		);
	...
	protected void preparePatch(Country country) {
	}
