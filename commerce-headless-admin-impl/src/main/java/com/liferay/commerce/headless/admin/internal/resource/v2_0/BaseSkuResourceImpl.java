...
public abstract class BaseSkuResourceImpl implements SkuResource {
	...
	public Error deleteSku(@PathParam("id") Long id) throws Exception {
		return new Error();
	}
	...
	@Tags(value = {@Tag(name = "Sku")})
	public Sku getSku(@PathParam("id") Long id) throws Exception {
		return new Sku();
	}
	...
	@Tags(value = {@Tag(name = "Sku")})
	public Page<Inventory> getInventorys(@PathParam("id") Long id)
		throws Exception {
