...
@Generated("")
@Path("/v2.0")
public abstract class BaseRegionResourceImpl implements RegionResource {

	@Override
	@DELETE
	@Path("/region/{id}")
	@Produces("application/json")
	@Tags(value = {@Tag(name = "Region")})
	public Error deleteRegion(@PathParam("id") Long id) throws Exception {
		return new Error();
	}
	...
	@Tags(value = {@Tag(name = "Region")})
	public Region getRegion(@PathParam("id") Long id) throws Exception {
		return new Region();
	}
	...
	@Tags(value = {@Tag(name = "Region")})
	public Error updateRegion(@PathParam("id") Long id, Region region)
		throws Exception {
	...
	protected String getJAXRSLink(String methodName, Object... values) {
		...
		URI resourceURI = UriBuilder.fromResource(
			BaseRegionResourceImpl.class
		).build();

		URI methodURI = UriBuilder.fromMethod(
			BaseRegionResourceImpl.class, methodName
		).build(
			values
		);
	...
	protected void preparePatch(Region region) {
	}
