...
public abstract class BaseWebSiteResourceImpl implements WebSiteResource {
	...
	@Tags(value = {@Tag(name = "WebSite")})
	public Page<WebSite> getWebSites() throws Exception {
	...
	protected String getJAXRSLink(String methodName, Object... values) {
		...
		URI resourceURI = UriBuilder.fromResource(
			BaseWebSiteResourceImpl.class
		).build();

		URI methodURI = UriBuilder.fromMethod(
			BaseWebSiteResourceImpl.class, methodName
		).build(
			values
		);
	...
	protected void preparePatch(WebSite webSite) {
	}
