...
public abstract class BaseAccountResourceImpl implements AccountResource {
	...
	@Tags(value = {@Tag(name = "Account")})
	public Error deleteAccount(@PathParam("id") Long id) throws Exception {
		return new Error();
	}
	...
	@Tags(value = {@Tag(name = "Account")})
	public Error updateAccount(@PathParam("id") Long id, Account account)
		throws Exception {
	...
	@Tags(value = {@Tag(name = "Account")})
	public Page<Address> getAddresses(@PathParam("id") Long id)
		throws Exception {
	...
	public Address upsertAccountAddress(
			@PathParam("id") Long id, Address address)
		throws Exception {
