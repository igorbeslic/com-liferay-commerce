...
public abstract class BaseAddressResourceImpl implements AddressResource {
	...
	public Error deleteAddress(@PathParam("id") Long id) throws Exception {
		return new Error();
	}
	...
	@Tags(value = {@Tag(name = "Address")})
	public Address getAddress(@PathParam("id") Long id) throws Exception {
		return new Address();
	}
	...
	@Tags(value = {@Tag(name = "Address")})
	public Error updateAddress(@PathParam("id") Long id, Address address)
		throws Exception {
	...
	protected String getJAXRSLink(String methodName, Object... values) {
		...
		URI resourceURI = UriBuilder.fromResource(
			BaseAddressResourceImpl.class
		).build();

		URI methodURI = UriBuilder.fromMethod(
			BaseAddressResourceImpl.class, methodName
		).build(
			values
		);
	...
	protected void preparePatch(Address address) {
	}
