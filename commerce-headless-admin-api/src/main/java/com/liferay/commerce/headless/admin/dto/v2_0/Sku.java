...
public class Sku {
	...
	@JsonIgnore
	public void setCost(
		UnsafeSupplier<java.math.BigDecimal, Exception> costUnsafeSupplier) {
	...
	public void setPrice(
		UnsafeSupplier<java.math.BigDecimal, Exception> priceUnsafeSupplier) {
	...
	public java.math.BigDecimal getPromoPrice() {
		return promoPrice;
	}
