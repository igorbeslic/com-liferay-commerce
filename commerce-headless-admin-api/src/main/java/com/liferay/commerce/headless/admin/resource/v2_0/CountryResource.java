...
public interface CountryResource {
	...
	public Page<Country> getCountries(Long groupId) throws Exception;

	public Country upsertCountry(Long groupId, Country country)
		throws Exception;

	public Error deleteCountry(Long id) throws Exception;

	public Country getCountry(Long id) throws Exception;

	public Error updateCountry(Long id, Long groupId, Country country)
		throws Exception;

	public Page<Region> getRegions(Long id) throws Exception;

	public Region upsertRegion(Long id, Region region) throws Exception;
