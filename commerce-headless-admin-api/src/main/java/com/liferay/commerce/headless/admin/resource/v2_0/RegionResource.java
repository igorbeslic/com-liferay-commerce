...
public interface RegionResource {
	...
	public Error deleteRegion(Long id) throws Exception;

	public Region getRegion(Long id) throws Exception;

	public Error updateRegion(Long id, Region region) throws Exception;
