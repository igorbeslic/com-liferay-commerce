...
public interface CurrencyResource {
	...
	public Page<Currency> getCurrencies(Long groupId) throws Exception;

	public Currency upsertCurrency(Long groupId, Currency currency)
		throws Exception;

	public Error deleteCurrency(Long id) throws Exception;

	public Currency getCurrency(Long id) throws Exception;

	public Error updateCurrency(Long id, Long groupId, Currency currency)
		throws Exception;
