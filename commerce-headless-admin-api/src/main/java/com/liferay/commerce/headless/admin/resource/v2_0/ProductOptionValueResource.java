...
public interface ProductOptionValueResource {
	...
	public Page<ProductOptionValue> getProductOptionValues(Long id)
		throws Exception;

	public ProductOptionValue upsertProductOptionValue(
			Long id, Long groupId, ProductOptionValue productOptionValue)
		throws Exception;

	public Error deleteProductOptionValue(Long id) throws Exception;
