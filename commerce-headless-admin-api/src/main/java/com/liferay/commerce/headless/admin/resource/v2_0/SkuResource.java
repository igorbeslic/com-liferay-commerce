...
public interface SkuResource {
	...
	public Error deleteSku(Long id) throws Exception;

	public Sku getSku(Long id) throws Exception;

	public Error updateSku(Long id, Long groupId, Sku sku) throws Exception;

	public Page<Inventory> getInventorys(Long id) throws Exception;

	public Inventory upsertInventory(Long id, Long groupId, Inventory inventory)
		throws Exception;
